...
export const ProductCard = ({ id, name, price, rating, image } : Props) => {
  ...
  return (
    <div className="bg-white shadow rounded-lg max-w-[300px] dark:bg-gray-800 dark:border-gray-100 flex flex-col">
      ...
      <div className="px-5 pb-5 flex-1 flex flex-col">
        <a href="#">
          <h3 className="text-gray-900 font-semibold text-md tracking-tight dark:text-white">
            {name}</h3>
        </a>
        ...
        <div className="flex items-center justify-between flex-1 self-end flex-wrap">
